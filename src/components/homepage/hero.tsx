...
const HeroSection = forwardRef<HTMLDivElement, HeroProps>(
  ({ scrollTargetRef, videoRef, ready }, ref) => {
    ...
    return (
      <section
        ref={ref}
        className="relative min-h-[100svh] flex flex-col justify-between snap-start"
      ...
      >
        ...
        <div className="sm:hidden absolute inset-0 w-full h-full bg-cover bg-center bg-no-repeat z-0" />
